...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Web app} (dành cho phía  quản trị viên): sử dụng Vite + React để tạo giao diện quản lý tốc độ cao, hỗ trợ các thao tác phức tạp như duyệt đăng ký, quản lý môn học.
    \end{itemize}
