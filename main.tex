...
\color{vol}{Phát triển ứng dụng đa nền tảng}
\\[-12pt]}                                         
% Số chương
% \fancyhead[RO]
...
% \addcontentsline{toc}{section}{\textbf{Chương II: Phân tích yêu cầu}}
% {\centering\vnmsans\Huge\textcolor{vol}{Chương II: Phân tích yêu cầu}\par}
% \subfile{Episode/Requirements}

% \newpage
% \section*{\phantomsection\label{epNLP.3}} 
% \addcontentsline{toc}{section}{\textbf{Chương III: Thiết kế thuật toán}}
% {\centering\vnmsans\Huge\textcolor{vol}{Chương III: Thiết kế thuật toán}\par}
% \subfile{Episode/Design}

\newpage
\section*{\phantomsection\label{epNLP.3}} 
\addcontentsline{toc}{section}{\textbf{Chương IV: Triển khai và đánh giá}}
{\centering\vnmsans\Huge\textcolor{vol}{Chương IV: Triển khai và đánh giá}\par}
\subfile{Episode/Implementation}

% \newpage
% \section*{\phantomsection\label{epNLP.3}} 
% \addcontentsline{toc}{section}{\textbf{Chương V: Tài liệu tham khảo và Mã nguồn}}
% {\centering\vnmsans\Huge\textcolor{vol}{Chương V: Tài liệu tham khảo và Mã nguồn}\par}
% \subfile{Episode/Refrence}
%==========================================LỜI KẾT============================================
\newpage
